...
public class LoginPageTestCases extends MobileApplicationExecutor {
    ...
    public void positiveLoginTest() {
        ...
        mobileDriver.findElement(By.name("Start Broadcast")).click();
        mobileDriver.findElement(By.name("Sign In")).click();
        mobileDriver.findElement(By.id("Auth_Email")).sendKeys("1@1.com");
        mobileDriver.findElement(By.name("Auth_Password")).sendKeys("111111");
        mobileDriver.hideKeyboard();

        mobileDriver.findElement(By.name("Auth_SignIn")).click();
